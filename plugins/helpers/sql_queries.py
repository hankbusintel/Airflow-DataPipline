                ...
                FROM (
                        ...
                        AND not exists
                            (
                                SELECT 1
                                FROM songplays sp
                                WHERE cast(TIMESTAMP 'epoch' + ts/1000 * interval '1 second' as timestamp) = sp.start_time
                                and userid = sp.userid
                            )
                    ) events
